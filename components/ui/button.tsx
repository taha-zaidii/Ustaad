...
/**
 * Button — conventional variants.
 *
 * The previous version had a heavy animated wipe (a `before` pseudo-
 * element that grew across the button on hover). It conflicted with
 * the calmer design language, so this rewrite uses simple solid /
 * outline / ghost / link variants with the standard colour tokens.
 */
